...
namespace OnlineEnrollment.Data
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // ── MINOR SUBJECTS (shared, CourseId = null) ──
            ...
            var allMajors = new Dictionary<int, string[]>
            {
                ...
                [2] = new[] { // BS Business Administration
                ...
                [4] = new[] { // BS Management Engineering
                ...
                [6] = new[] { // BS Information Technology
                ...
                [8] = new[] { // BS Electrical Engineering
                ...
                [16] = new[] { // BS Elementary Education
                ...
                [19] = new[] { // Hotel & Restaurant Management
